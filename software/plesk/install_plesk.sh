...
sudo PLESK_DB_DSN_PREFIX=mysql://plesk1:hola@44.214.48.106/host1_ ./plesk-installer --select-product-id plesk --select-release-latest --installation-type Recommended
